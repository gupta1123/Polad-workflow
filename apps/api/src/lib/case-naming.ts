...
function getInternalNameHints() {
  const configured =
    ...
    "polaad,polaad steel,polaad steels,polaad steel alloys,polaad steel alloys pvt ltd,polaad steel alloys private limited";
  return configured
    .split(",")
      ...
      [
        {
          ...
          content:
            ...
            "For Polaad procurement packets, prefer the supplier/vendor over Polaad. " +
