        ...
        [
            {
              ...
              "For party roles on seller-issued documents, vendorName is the issuing supplier/seller/consignor and buyerName is the receiving buyer, bill-to party, customer, or purchaser. Only use ship-to/consignee/recipient as buyerName when that party is Polaad. " +
            ...
            content: [
              {
                ...
                text:
                  ...
                  "If both supplier and receiver are visible, map seller-issued documents as seller/consignor to vendorName and receiving buyer/bill-to/customer/purchaser to buyerName. Only use ship-to/consignee/recipient as buyerName when that party is Polaad. For purchase orders, map the supplier/vendor receiving the order to vendorName. " +
