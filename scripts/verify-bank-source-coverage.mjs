...
if(!args.includes('--import')||!id)throw Error('Use --import ID [--live-recovery] with protected Polaad environment.');
const url=process.env.SUPABASE_URL||process.env.NEXT_PUBLIC_SUPABASE_URL;
if(new URL(url).hostname!=='xojorrtjxmopxjlvvbki.supabase.co')throw Error('Wrong project: Polaad only.');
