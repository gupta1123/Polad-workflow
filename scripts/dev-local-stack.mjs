...
const serviceDefinitions = [
  ["frontend", "npm run dev --workspace @polaad/web"],
  ["api", "npm run dev --workspace @polaad/api"],
  ["worker", "npm run worker:local --workspace @polaad/api"],
  ["tally-live-gateway", "npm run dev --workspace @polaad/tally-live-gateway", 3002],
];
...
console.log("Polaad local stack starting: frontend :3000, API :3001, Tally live gateway :3002, and worker.");
