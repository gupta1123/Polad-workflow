...
const configuredBrandLogoPath = path.join(__dirname, "assets", "polaad-logo.png");
const brandLogoPath = fs.existsSync(configuredBrandLogoPath) ? configuredBrandLogoPath : undefined;
...
async function requestDirectSemanticEmbeddings(inputs, refresh = false) {
  ...
  const response = await nodeFetch(direct.endpoint, {
    ...
    headers: {
      ...
      "HTTP-Referer": "https://polaad.com",
      "X-Title": "Polaad Tally Connector",
    },
...
function createWindow() {
  mainWindow = new BrowserWindow({
    ...
    hasShadow: false,
    roundedCorners: true,
    ...(brandLogoPath ? { icon: brandLogoPath } : {}),
