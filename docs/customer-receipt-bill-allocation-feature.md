...
4. In `Account`, enter `Polaad HDFC`.
...
7. If bill-wise details open, use:
   ...
   - `Name`: `ADV-OLD-001`
   - `Amount`: `5000 Cr`
8. If Tally opens `Bank Allocations for: Polaad HDFC`, keep `Cheque/DD` or choose `Others`, leave `Bank Name` blank, and accept the popup.
9. Save the voucher.
