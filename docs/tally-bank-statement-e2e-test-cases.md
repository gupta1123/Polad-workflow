...
- Initial statement file: `test-assets/bank-statements/polaad-hdfc-june-sample.csv`
- Latest statement file: `test-assets/bank-statements/polaad-hdfc-june-latest-sample.csv`
- April Day Book visibility file: `test-assets/bank-statements/polaad-hdfc-apr-1-unique-sample.csv`
- Bank name: `Local Test Bank`
- Account number: `1234567890`
- Account holder name: `Polaad Test`
...
- [ ] Confirm status shows `Company: Polaad Test`.
...
- [ ] Upload `test-assets/bank-statements/polaad-hdfc-june-sample.csv`.
- [ ] Enter bank name `Local Test Bank` if needed.
- [ ] Enter account number `1234567890` if needed.
- [ ] Enter account holder name `Polaad Test` if needed.
...
- [ ] Go to `Bank Statements`.
- [ ] Upload `test-assets/bank-statements/polaad-hdfc-june-sample.csv` again.
...
- [ ] Go to `Bank Statements`.
- [ ] Upload `test-assets/bank-statements/polaad-hdfc-june-latest-sample.csv`.
- [ ] Preview and confirm the import.
...
```powershell
node .\src\bridge.mjs start --company-name "Polaad Test"
```
...
```powershell
node .\src\bridge.mjs find-vouchers --refs APR1-CHG-HDFC-0003,APR1-RTGS-HDFC-0004 --company-name "Polaad Test"
```

- [ ] Run the bridge read-only voucher dump:

```powershell
node .\src\bridge.mjs list-vouchers --company-name "Polaad Test"
```
...
- [ ] Upload `test-assets/bank-statements/polaad-hdfc-apr-1-unique-sample.csv`.
