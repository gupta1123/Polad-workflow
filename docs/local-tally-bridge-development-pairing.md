...
```text
polaad-workflow/apps/tally-bridge
```
...
Run the pair command from `C:\Polaad\tally-bridge`:
...
```powershell
npm run pair -- --api-base https://polaad-workflow-465859fe2891.herokuapp.com --connection-id c5723944-f4a1-4566-9601-0e28a96294f6 --pairing-code 519714
```
...
Copy the whole `apps/tally-bridge` folder to `C:\Polaad\tally-bridge`, then run from there.
